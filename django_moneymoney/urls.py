...
router.register(r'investmentsrecomendationmethods', money_views.InvestmentsRecomendationMethodsViewSet)
...
router.register(r'strategiestypes', money_views.StrategiesTypesViewSet)
